import type { Palette, Shadows } from '@mui/material/styles'
import { alpha } from '@mui/material/styles'

export const createShadow = (color: string): Shadows => {
...
export const createCustomShadow = (color: string, palette: Palette): any => {
